...
export default function IonExchangePipelineVisual() {
    ...
    () => [
      {
        ...
        summary:
          "Capture NL instructions from MS Teams and create a versioned design session.",
        whatHappens: [
        ...
        references: [{ kind: "tab", label: "Outputs", tab: "prototype" }],
      },
      {
        id: "perception",
        ...
        summary:
          "LLM-assisted understanding of user intent, entities, and high-level parameters.",
        whatHappens: [
      ...
      },
      {
        ...
        summary:
          "Propose candidate units and connections; preserve ambiguity (no silent assumptions).",
        whatHappens: [
      ...
      },
      {
        ...
        summary:
          "Canonicalize into strict Design IR; enforce schema and provenance.",
        whatHappens: [
      ...
      },
      {
        ...
        summary:
          "Apply sequencing/mandatory checks; route to Teams HITL on ambiguity or rule violations.",
        whatHappens: [
      ...
      },
      {
        ...
        summary:
          "Render validated IR as an editable conceptual PFD (single output in V1).",
        whatHappens: [
          "Map IR units → nodes",
      ...
      ambiguities: [
        {
          ...
          reason:
            "Pretreatment specified broadly; assumes DMF within V1 component set",
        },
      ],
    }),
    ...
    () => ({
      ...
      candidates: {
        units: [
          ...
          { type: "CHEMICAL_DOSING", confidence: 0.9 },
  ...
  const validation = useMemo(
    () => ({
      ...
      confidence_gate: {
        threshold: 0.85,
        observed: perception.confidence,
        result: "PASS",
      },
      hitl: {
        required: true,
        route: "MS_TEAMS",
        question:
          "Reject recycle typically requires an equalization tank. Proceed without it for conceptual PFD?",
      },
    }),
      ...
      nodes: [
        {
          ...
          type: "default",
          position: { x: 80, y: 120 },
          data: { label: "Raw Water Tank" },
        },
        {
          id: "U2",
          type: "default",
          position: { x: 280, y: 120 },
          data: { label: "Chemical Dosing" },
        },
        {
          id: "U3",
          type: "default",
        ...
        },
        {
          ...
          type: "default",
          position: { x: 880, y: 60 },
          data: { label: "Permeate Tank" },
        },
        {
          id: "U6",
          type: "default",
          position: { x: 880, y: 180 },
          data: { label: "Reject Tank" },
        },
        {
          id: "U7",
          type: "default",
          position: { x: 680, y: 260 },
          data: { label: "Reject Recycle" },
        },
      ],
      edges: [
  ...
  const outputsByStage: Record<StageId, StageOutput[]> = useMemo(
    () => ({
      instruction: [
        ...
        {
          kind: "json",
          title: "Instruction Metadata",
          value: pretty(instruction),
        },
      ],
      perception: [
        {
          kind: "json",
          title: "Perceived Intent",
          value: pretty(perception),
        },
      ],
      assisted_structuring: [
        {
          kind: "json",
          title: "Candidate Units & Connections",
      ...
      ir_enforcement: [
        {
          kind: "json",
          title: "Canonical Design IR (System of Record)",
          value: pretty(designIR),
        },
      ],
      validation: [
        {
      ...
      pfd_render: [
        {
          kind: "json",
          title: "React Flow Diagram Model",
          value: pretty(reactFlowModel),
        },
      ],
    }),
  ...
  return (
    <div className="w-full p-4 md:p-6 space-y-4 max-w-6xl mx-auto">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <div className="text-xl md:text-2xl font-semibold">
            NL → PFD Pipeline (Ion Exchange)
          </div>
          <div className="text-sm text-muted-foreground">
            Visual prototype of a governed pipeline: Natural Language → Design
            IR → Validation/HITL → PFD
          </div>
        </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setIdx((v) => Math.min(stages.length - 1, v + 1))
                    }
            ...
            <div className="lg:col-span-8 space-y-3">
              ...
              >
                <TabsList className="grid grid-cols-7 gap-1">
                  <TabsTrigger value="prototype" className="text-xs px-2 py-1">
                    Out
                  </TabsTrigger>
                  <TabsTrigger value="ir" className="text-xs px-2 py-1">
                    IR
                  </TabsTrigger>
                  <TabsTrigger value="intent" className="text-xs px-2 py-1">
                    Intent
                  </TabsTrigger>
                  <TabsTrigger
                    value="components"
                  ...
                  <TabsTrigger value="layout" className="text-xs px-2 py-1">
                    Layout
                  </TabsTrigger>
                  <TabsTrigger
                    value="candidate"
                  ...
                  <TabsTrigger value="rules" className="text-xs px-2 py-1">
                    Rules
                  </TabsTrigger>
                </TabsList>
...
{`{
  ...
  provenance: { instruction_version: number, llm_confidence: number }
                      ...
                      <div className="text-xs text-muted-foreground mt-3">
                        IR is authoritative. Validation and rendering operate on
                        IR (not on free-form text).
                      </div>
                    </CardContent>
                  </Card>
                </TabsContent>
                  ...
                  <Card className="rounded-2xl">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm font-medium">
                          Intent Schema (Perception Output)
                        </div>
                      </div>
                      <Separator className="my-3" />
                      <pre className="text-xs rounded-xl bg-muted p-3 overflow-auto whitespace-pre-wrap">
{`{
  ...
  notes?: string[]
                      ...
                      <div className="text-xs text-muted-foreground mt-3">
                        Intent Perception uses this schema as its extraction
                        contract and outputs an instance of it for downstream
                        structuring.
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="rounded-2xl">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2">
                        <Database className="h-4 w-4" />
                        <div className="text-sm font-medium">
                          V1 Component Vocabulary (with metadata)
                        </div>
                      </div>
                      <Separator className="my-3" />
                      <ScrollArea className="h-[420px] pr-2">
                          ...
                          {[
                            {
                              ...
                              description:
                                "Source/holding tank feeding pretreatment.",
                            ...
                            },
                            {
                              ...
                              description:
                                "Chemical addition (e.g., chlorination/coagulation/pH correction) before filtration.",
                            ...
                            },
                            {
                              ...
                              description:
                                "Pretreatment filtration unit to remove suspended solids before RO.",
                            ...
                            },
                            {
                              ...
                              description:
                                "Core treatment unit producing permeate and reject streams.",
                            ...
                            },
                            {
                              ...
                              label: "Permeate Tank",
                              description:
                                "Storage/collection for RO permeate stream.",
                            ...
                            },
                            {
                              ...
                              label: "Reject Tank",
                              description:
                                "Collection/equalization for RO reject stream (conceptual in V1).",
                            ...
                            },
                            {
                              ...
                              description:
                                "Recycle loop returning reject (or a portion) upstream (conceptual in V1).",
                      ...
                      <div className="text-xs text-muted-foreground mt-3">
                        This vocabulary is used by Intent Perception and
                        Assisted Structuring to stay within the finite V1
                        component set.
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="rounded-2xl">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="text-sm font-medium">
                          Deterministic Layout Policy (x/y)
                        </div>
                      </div>
                      <Separator className="my-3" />
                      <pre className="text-xs rounded-xl bg-muted p-3 overflow-auto whitespace-pre-wrap">
{`{
  ...
  note: "Layout is presentation-only; Design IR remains tool-agnostic"
                      ...
                      <div className="text-xs text-muted-foreground mt-3">
                        Positions are computed deterministically from IR + this
                        policy. They are not produced by the LLM.
                      </div>
                    </CardContent>
                  </Card>
                </TabsContent>
                  ...
                  <Card className="rounded-2xl">
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2">
                        <Wand2 className="h-4 w-4" />
                        <div className="text-sm font-medium">
                          Candidate Intent Schema (Agent Output)
                        </div>
                      </div>
                      <Separator className="my-3" />
                      <pre className="text-xs rounded-xl bg-muted p-3 overflow-auto whitespace-pre-wrap">
{`{
  ...
  ambiguities: [ { item, reason } ]
                      ...
                      <div className="text-xs text-muted-foreground mt-3">
                        Sequencing is captured in candidates.connections
                        (edges). These are proposals until canonicalized into
                        Design IR.
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="rounded-2xl">
                    <CardContent className="p-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {[
                          "RO_REQUIRES_PRETREATMENT",
                          "DOSING_BEFORE_FILTRATION",
                          "FINITE_COMPONENT_SET_V1",
                          "CONFIDENCE_GATE",
                      ...
                      <div className="text-xs text-muted-foreground mt-3">
                        V1 focuses on sequencing and mandatory checks (no
                        sizing, no optimization).
                      </div>
                    </CardContent>
                  </Card>
                </TabsContent>
      ...
      <div className="text-xs text-muted-foreground">
        Tip: Replace mock objects with real services; keep the probabilistic →
        deterministic boundary unchanged.
      </div>
    </div>
  );
}
